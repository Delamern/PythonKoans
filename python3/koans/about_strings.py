...
class AboutStrings(Koan):
    ...
    def test_raw_strings_are_also_strings(self): #Raw strings will allow literals like backslash. It tells it to take the string as is
        string = r"Konnichi wa, world!"
        self.assertEqual(True, isinstance(string, str))

    def test_what_does_raw_do(self):
            string = r"D\o\n't"
...
#Without the \n\ the variable doesn't match the first " to the last "
